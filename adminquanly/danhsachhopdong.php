...
if(isset($_SESSION['username'])){
	include('../ketnoi.php');
	$query = mysqli_query($conn,"select * from hopdong inner join sinhvien on sinhvien.mssv=hopdong.mssv where khunha='".$_SESSION['adminquanly']."'");
}
...
<?php
 ...
 ?>
 <div class="container">
 <div class="boxtitle text-center" style="background:#d0493b">DANH SÁCH HỢP ĐỒNG</div>
 <?php

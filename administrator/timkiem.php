...
<?php
   ...
   $change = mysqli_query($conn,"UPDATE sinhvien SET ngaysinh ='$ngaysinh', email ='$email', cmnd ='$cmnd' , dantoc =N'$dantoc', noisinh =N'$noisinh', quoctich =N'$quoctich', sdt ='$sdt',password='$password' where mssv = '".$_SESSION['masosv']."'");
            ...
            <table class="table">
               ...
               <tr>
                  ...
                  <td><input type="text" name="cmnd" value="<?php echo $row['cmnd']; ?>" maxlength="20"  style="width:255px;" />
                   ...
                   <td>Password:</td>
                  <td><input type="text" name="password" value="<?php echo $row['password']; ?>" maxlength="20" style="width:120px;" /></td>
                  <td></td>
                  <td></td>
                  <td></td>
                  <td></td>
               ...
               <tr>
                  <td>Khu ở:</td>
                  <td><input type="text" readonly disabled value="<?php echo $row['khunha']; ?>" maxlength="20" style="color:Black;font-weight:bold;width:50px;text-align:center;font-size:13px" />
                  </td>
                  <td>Phòng ở:</td>
                  <td><input type="text" readonly disabled value="<?php echo $row['sophong']; ?>" maxlength="20" style="color:Black;font-weight:bold;width:50px; text-align:center;font-size:13px" />
                  </td>
